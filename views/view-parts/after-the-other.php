  ...
  <div class="col-12 table-responsive">
    <table class="prestable pres-table after_the_other">
      <tbody class="sortable">
        <?php 
          $result = $db->prepare("SELECT * FROM save_prescription_drugs where category='after_the_other' AND prescription_number=$prescription_number ORDER BY order_no asc");
          $result->execute();
          $r=1;
        $s = 1;
