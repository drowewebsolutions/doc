 <div class="modal fade" id="assign_a_doctor" aria-hidden="true">
    <div class="modal-dialog">
      <form method="post" action="<?php echo $url; ?>control-files/set-tepm_assign_a_doctor.php">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <select class="form-control select2" multiple="multiple" style="width: 100%;" name="note">
                        <?php
