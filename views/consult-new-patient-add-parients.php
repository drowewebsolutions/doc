...
$ord_id = 5;
$nd = 'c';
  $retunurl ='consult-new-patient-add-parients';
...
<link rel="stylesheet" href="<?php echo $url; ?>dist/css/prescription.css">
 <div id="htm"></div>
  <div class="nes-stat">
    <div class="container">
      <form method="post" id="configform" action="<?php echo $url; ?>control-files/save-consult-new-patient-add-parients.php">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 invoice-col">
              <button type="button" class="btn btn-block btn-primary col-11" data-toggle="modal" data-target="#diagnoses">Add diagnoses
              </button>
              <br>
              <h6>DIAGNOSES</h6>
              <div id="htm"></div>
        ...
        <div>
          ...
          <div class="row no-print">
              <div class="col-12">
                  ...
                  <a href="<?php echo $url; ?>control-files/clear-prescription.php?id=<?php echo $id; ?>" class="btn bg-danger"> Delete Prescription</a>
              </div>
          </div>
          <br>
        </div>
