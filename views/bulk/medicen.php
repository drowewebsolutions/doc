  <div class="modal fade" id="short_term" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <form method="post" action="<?php echo $url; ?>control-files/bulk/bulk_prescription.php">
        <input type="hidden" class="ids" value="<?php echo $id; ?>" name="id">
        <input type="hidden" class="ids" value="<?php echo $id; ?>" name="mid">
